...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      ...
      <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
        ...
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-6xl lg:text-7xl leading-tight text-white mb-20">
        ...
        {/* SUBTÍTULO */}
        <p className="font-poppins text-regular text-white text-base md:text-xl mb-10 max-w-3xl leading-relaxed">
