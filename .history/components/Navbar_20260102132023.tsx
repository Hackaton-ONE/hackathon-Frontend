...
export function Navbar() {
  ...
  return (
    ...
    <div className="relative top-0 left-0 w-full z-50 px-4 py-8">
      ...
      <div className="max-w-[1500px] mx-auto flex justify-between items-center lg:grid lg:grid-cols-3">
        ...
        <div className="flex justify-end items-center gap-4 z-50">
          ...
          <div className="hidden lg:flex items-center gap-2 pl-4">
            ...
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-neon-green to-emerald-600 flex items-center justify-center text-white font-bold border-2 border-white shadow-md">
              D
            </div>
          </div>
