...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      ...
      {/* =========================================
          CONTEÚDO PRINCIPAL
          ========================================= */}
      <div className="relative z-100 max-w-5xl mx-auto text-center flex flex-col items-center">
        
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-6xl lg:text-7xl xl:text-7xl leading-tight text-white mb-8 lg:mb-20 max-w-5xl">
