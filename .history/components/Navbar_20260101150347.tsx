...
// Componente NavLink (Mantido igual)
...
export function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-0 w-full flex justify-center z-50">
      ...
      {/* === MENU MOBILE DROPDOWN (Atualizado com o estilo da referência) === */}
      {isOpen && (
        <div className="
          absolute top-20 
          w-[90%] max-w-sm 
          /* MUDANÇA 1: Fundo escuro (Slate 900/Mood Dark) com blur, igual à referência */
        ...
        ">
          ...
          {/* MUDANÇA 2: Linha divisória e botão estilo "Outline" igual à referência */}
