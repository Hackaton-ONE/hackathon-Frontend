...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      ...
      <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
        ...
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-6xl lg:text-7xl xl:text-8xl leading-tight text-white mb-20">
        ...
        {/* SUBTÍTULO */}
        <p className="font-poppins font-light text-white text-base md:text-xl mb-20 max-w-3xl leading-relaxed">
