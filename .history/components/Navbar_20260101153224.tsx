    ...
    <div className="relative top-0 left-0 w-full z-50 px-4 py-10">
      <div className="max-w-[1600px] mx-auto relative flex items-center justify-between">
        ...
        {/* =======================
           ...
           ======================= */}
        <nav className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-8 pl-8 pr-2 py-2 rounded-2xl bg-mood-dark/80 backdrop-blur-md border border-white/10 shadow-lg shadow-black/20">
