...
export function Navbar() {
  ...
  return (
    ...
    <div className="relative top-0 left-0 w-full z-50 px-4 py-12">
      <div className="max-w-[1600px] mx-auto relative flex items-center justify-between">
        
        {/* =======================
            1. LOGO (Lado Esquerdo)
           ======================= */}
        <Link href="/" className="flex items-center gap-0 z-50 group">
          <div className="relative w-suut0 h-8 flex items-center justify-center">
            <Image
            src="/logo.svg"
            alt="Logo MoodMatrix"
            fill
          ...
          {/* Texto com a fonte MuseoModerno */}
          <span className="text-white font-medium text-lg font-museo tracking-wide">
        ...
        {/* =======================
           ...
           ======================= */}
        <nav className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-8 pl-8 pr-8 py-3 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg shadow-black/20">
          ...
          <Link href="/analisar">
            <button className="bg-white hover:bg-neon-orange text-black font-poppins font-bold text-sm px-5 py-2 rounded-md transition-all duration-200">
              Analisar
            </button>
          </Link>
        </nav>
