...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      <div 
        className="
          absolute 
          top-[-400px] 
          right-[-100px] lg:right-[-300px] /* Ajuste fino para telas diferentes */
          w-[743px] 
          h-[817px] 
          bg-blue-light/30 
          blur-[160px] 
      ...
      */}
      ...
      {/* =========================================
          CONTEÚDO PRINCIPAL
          ========================================= */}
      <div className="relative z-100 max-w-7xl mx-auto text-center flex flex-col items-center">
        
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-6xl lg:text-7xl xl:text-8xl leading-tight text-white mb-8 lg:mb-20 max-w-7xl">
        ...
        {/* SUBTÍTULO */}
        <p className="font-poppins font-light text-white text-base md:text-xl mb-8 lg:mb-20 max-w-2xl">
