...
export function TechStack() {
  ...
  return (
    <section className="pt-32 lg:pt-48 py-12 px-4 lg:px-8 relative z-20"> {/* z-20 para ficar acima de qualquer glow residual */}
      <div className="max-w-5xl mx-auto">
        
        {/* Container Escuro e Longo (Igual à imagem) */}
        <div className="bg-mood-dark/80 backdrop-blur-md border border-white/10 rounded-3xl p-6 lg:p-10 shadow-2xl">
