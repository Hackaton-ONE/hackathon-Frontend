  ...
  return (
    ...
    <div className="relative top-0 left-0 w-full z-50 px-4 py-8">
      ...
      {/* =======================
         ...
         ======================= */}
      {isOpen && (
        <div className="lg:absolute top-24 left-4 right-4 z-40 bg-mood-dark/95 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-2xl animate-in fade-in slide-in-from-top-5">
