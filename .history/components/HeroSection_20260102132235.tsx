...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center flex flex-col items-center">
        ...
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-6xl lg:text-7xl 2xl:text-8xl leading-tight text-white mb-8 md:mb-14 lg:mb-20 max-w-7xl lg:max-w-5xl md:max-w-5xl">
