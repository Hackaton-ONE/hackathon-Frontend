...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      <div 
        className="
          absolute 
          top-[-400px] 
          right-[-100px] lg:right-[-400px] /* Ajuste fino para telas diferentes */
          w-[743px] 
          h-[817px] 
          bg-blue-light/30 
          blur-[160px] 
      ...
      */}
      ...
      <div className="relative z-100 max-w-5xl mx-auto text-center flex flex-col items-center">
        ...
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-6xl lg:text-7xl xl:text-7xl leading-tight text-white mb-8 lg:mb-20">
