    ...
    <div className="relative top-0 left-0 w-full z-50 px-4 py-12">
      <div className="max-w-[1600px] mx-auto relative flex items-center justify-between">
        ...
        {/* =======================
           ...
           ======================= */}
        <Link href="/" className="flex items-center gap-1 z-50 group drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]">
          ...
          <span className="text-white font-reglar text-xs font-museo tracking-wider">
