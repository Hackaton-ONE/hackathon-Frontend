...
const NavLink = ({ href, children }: { href: string; children: React.ReactNode }) => (
  ...
  >
    {children}
    <span className="absolute -bottom-1 left-0 w-0 h-[2px] bg-blue-defa transition-all duration-300 ease-out group-hover:w-full" />
  </Link>
);
      ...
      <div className="max-w-[1600px] mx-auto flex justify-between items-center md:grid md:grid-cols-3">
        ...
        <div className="flex justify-start">
          <Link href="/" className="flex items-center gap-1 z-50 group">
            ...
            <span className="text-white font-medium text-xs font-museo tracking-wider transition-opacity group-hover:opacity-80">
