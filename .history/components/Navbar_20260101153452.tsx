    ...
    <div className="relative top-0 left-0 w-full z-50 px-4 py-10">
      <div className="max-w-[1600px] mx-auto relative flex items-center justify-between">
        ...
        <nav className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-10 pl-8 pr-8 py-3 rounded-2xl bg-mood-dark/80 backdrop-blur-md border border-white/10 shadow-lg shadow-black/20">
          ...
          <Link href="/analisar">
            <button className="bg-white hover:bg-neon-orange text-black border  font-poppins font-bold text-sm px-5 py-2 rounded-full transition-all duration-200 hover:scale-105 active:scale-95">
              Analisar
            </button>
          </Link>
        </nav>
