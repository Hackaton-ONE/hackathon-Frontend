...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      <div 
        className="
          absolute 
          top-[-300px] 
          right-[-100px] xl:right-[-300px] /* Ajuste fino para telas diferentes */
          w-[743px] 
          h-[817px] 
          bg-blue-light/30 
          blur-[50px] 
      ...
      */}
      ...
      <div className="relative z-100 max-w-7xl mx-auto text-center flex flex-col items-center">
        ...
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-5xl lg:text-7xl xl:text-8xl leading-tight text-white mb-8 md:mb-14 lg:mb-20 max-w-7xl">
