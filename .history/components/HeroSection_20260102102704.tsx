...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      <div 
        className="
          absolute 
          top-[-78px] 
          right-[-100px] lg:right-[-50px] /* Ajuste fino para telas diferentes */
          w-[743px] 
          h-[817px] 
          bg-blue-light/30 
          blur-[160px] 
      ...
      */}
      ...
      <div className="max-w-7xl mx-auto text-center flex flex-col items-center">
        ...
        {/* TÍTULO */}
        <h1 className="font-inter font-black text-4xl md:text-6xl lg:text-7xl xl:text-7xl leading-tight text-white mb-8 lg:mb-20 max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link href="/analisar">
            <Button variant="primary" className="w-full sm:w-auto text-lg px-8 lg:px-10 py-3 bg-blue-default hover:bg-neon-green font-poppins">
              Começar Análise
            </Button>
          </Link>
