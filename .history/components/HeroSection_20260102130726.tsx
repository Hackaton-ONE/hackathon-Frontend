...
{/* 1. ELIPSE MAIOR (Direita/Topo) 
      ...
      */}
      <div 
        className="
          absolute 
          top-[-500px] xl:top-[-300px] lg:top-[-250px]
          right-[-600px] lg:right-[-100px] xl:right-[-300px] /* Ajuste fino para telas diferentes */
          w-[743px] 
          h-[817px] 
          bg-blue-light/30 
          blur-[50px] 
      ...
      */}
      <div 
        className="
          absolute 
          top-[300px] lg:top-[200px] 2xl:top-[400px]
          left-[-200px] lg:left-[-100px] 2xl:left-[-100px]
          w-[282px] 
          h-[343px] 
          bg-blue-light/30 
          blur-[50px] 
