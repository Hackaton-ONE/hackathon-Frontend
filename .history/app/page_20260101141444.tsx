...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-10 gap-8 bg-mood-dark">
      
      <h1 className="text-4xl font-poppins font-bold text-white bg-clip-text bg-gradient-to-r from-blue-DEFAULT to-neon-green">
        UI Kit Check
      </h1>
