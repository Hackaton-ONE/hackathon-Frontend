  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 gap-8">
      ...
      <div className="text-center">
        ...
        <h1 className="font-poppins text-5xl font-bold text-white bg-clip-text bg-gradient-to-r from-neon-blue to-neon-green">
          MoodMatrix
        </h1>
      </div>
      ...
      <div className="text-center">
        ...
        <h1 className="text-5xl font0 font-bold text-white">
          MoodMatrix
        </h1>
      </div>
